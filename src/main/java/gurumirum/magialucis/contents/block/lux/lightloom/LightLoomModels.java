...
public final class LightLoomModels {
	...
	public static final ModelResourceLocation ITEM_BASE = new ModelResourceLocation(MagiaLucisMod.id("item/lightloom_base"), ModelResourceLocation.STANDALONE_VARIANT);
