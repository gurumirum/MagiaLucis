...
public class LightCylinderShaderInstance extends ShaderInstance {
	...
	public void setDefaultUniforms(VertexFormat.@NotNull Mode mode, @NotNull Matrix4f projectionMatrix,
		...
		if (this.lightStart != null) this.lightStart.set(this.vec4.set(LightEffect.lightStart(this.vec3), 0));
		if (this.lightEnd != null) this.lightEnd.set(this.vec4.set(LightEffect.lightEnd(this.vec3), 0));
