package gurumirum.gemthing.client.model;
...
public class GemGolemModel<T extends GemGolemEntity> extends HierarchicalModel<T> {
    ...
    public GemGolemModel(ModelPart pRoot) {
        this.root = pRoot;
