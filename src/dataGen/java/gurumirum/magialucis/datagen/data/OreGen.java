package gurumirum.magialucis.datagen.data;
...
public final class OreGen {
	...
	public static void addConfigureFeature(BootstrapContext<ConfiguredFeature<?, ?>> ctx) {
		cfg(SILVER, l -> {
	...
	public static void addPlacedFeature(BootstrapContext<PlacedFeature> ctx){
	...
	public static void addBiomeModifier(BootstrapContext<BiomeModifier> ctx){
	...
	private static void cfg(Ore ore, Consumer<List<OreConfiguration.TargetBlockState>> consumer) {
		List<OreConfiguration.TargetBlockState> targetBlockStates = ore.entries().map(e -> target(switch (e.getKey()) {
